...
function rh_template_single_add_to_cart()
{
    ...
    if ($product->is_in_stock()) : ?>
        <form class="cart"
            ...
            <div class="<?php echo esc_attr(apply_filters('woocommerce_product_price_class', 'price')); ?>"><span
                        class="price-num"><?php echo $product->get_price_html(); ?></span><span class="price-comment">full-time price</span>
            </div>
                    ...
                    <?php while (have_rows('videograph_portfolio')) : the_row(); ?>
                        ...
                        <a href="<?php the_sub_field('video_link'); ?>">
                            <li class="video-portfolio-vid">
                                ...
                                $embedLink = 'https://www.youtube.com/embed/' . $matches[1]; ?>
                                <div class="iframe-container">
                                    <iframe src="<?php echo $embedLink ?>" title="YouTube video player" frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen></iframe>
                                </div>
